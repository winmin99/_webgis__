...
var KTMenu = function (elementId, options) {
  ...
  var Plugin = {
    ...
    build: function () {
      ...
      the.eventHandlers['event_7'] = KTUtil.on(
        element,
        '.kt-menu__toggle_all',
        'click',
        Plugin.handleAllAccordion
      );
    ...
    reset: function () {
      ...
      // CUSTOM: close all menus
      KTUtil.off(element, 'click', the.eventHandlers['event_7']);
    },
    ...
    handleSubmenuAccordion: function (e, el) {
      ...
      if (li && submenu) {
        ...
        if (KTUtil.hasClass(li, 'kt-menu__item--open') === false) {
          // hide other accordions, currently disabled
    ...
    handleAllAccordion: function (e, el) {
      var open = 0;
      var speed = the.options.accordion.slideSpeed;
      ...
      item.forEach(function (el_) {
        if (el_.classList.contains('kt-menu__item--open')) {
          open++;
          var submenu_ = KTUtil.child(el_, '.kt-menu__submenu');
          KTUtil.slideUp(submenu_, speed, function () {
            KTUtil.removeClass(el_, 'kt-menu__item--open');
      ...
      if (open === 0) {
        item.forEach(function (el_) {
          if (!el_.classList.contains('ol-table-code')) {
            var li = el_.closest('.kt-menu__item');

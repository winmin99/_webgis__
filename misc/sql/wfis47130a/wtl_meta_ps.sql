ALTER TABLE public.wtl_meta_ps
    ADD COLUMN IF NOT EXISTS geom geometry(MultiPoint, 5187);

CREATE OR REPLACE VIEW public.viw_wtl_meta_ps
...
FROM wtl_meta_ps meta_tb
         ...
         LEFT JOIN wtl_wtssa_as wsb_tb ON meta_tb.wsb_cde = wsb_tb.wsg_cde
         LEFT JOIN bml_badm_as bjd_tb ON meta_tb.hom_bjd = bjd_tb.bjd_cde
